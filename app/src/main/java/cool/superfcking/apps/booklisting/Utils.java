...
public final class Utils {
    ...
    /**
     * Query the Google Books API to get all books matching query
     */
    public static List<Book> fetchBooks(String requestUrl) {
        ...
        List<Book> books = extractDetailsFromResponse(jsonResponse);
    ...
    /**
     * Return an list of books after parsing out information
     */
    private static List<Book> extractDetailsFromResponse(String bookJSON) {
        ...
        try {
            ...
            // If there are results in the book array, loop through them
            for(int i = 0; i < bookArray.length(); i++){
                JSONObject thisBook = bookArray.getJSONObject(i);
                ...
                if(volumeInfo.has("title") &&
                    ...
                    switch (authorArray.length()){
                        case 1:
                            author = author + authorArray.getString(0);
                            break;
                        ...
                        default:
                            for(int j = 0; j < authorArray.length(); j++){
                                if(j < authorArray.length() - 1) {
                                    ...
                                    author = author + "and " + authorArray.getString(j);
                                }
                            }
                    }
